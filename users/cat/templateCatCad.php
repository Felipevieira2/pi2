    ...
    <div class="panel-body">
        ...
        <div id="pager" class="pager">
            <form method= "POST" enctype="multipart/form-data">
                ...
                <p>
                    <label>Nome</label> 
                    <input class="formInput inputBorder" maxlength="50" type="text" name="nomeCategoria"> 
                </p>

                <p> 
                    <label>Descrição</label>
                    <textarea rows="4" cols="40" maxlength="100" class="formInput inputBorder" name="descCategoria"></textarea> 
                </p>
                <span class="botao voltar">
                    <a href="?menu=categories">Voltar</a>
                </span>
                
                <input class="botao" type="submit" value="Enviar" name="btnGravar">
                </center>
                </form>
