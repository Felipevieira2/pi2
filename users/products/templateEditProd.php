        ...
        <div id="pager" class="pager">
            ...
            <form method= "POST" enctype="multipart/form-data">
                <center>
                    ...
                    <textarea rows="10" cols="90" maxlength="500" class="formInput inputBorder" name="descProduto"><?php echo utf8_encode($produto[$idProduto]['descProduto']);?></textarea>
                ...
                <span class="botao botaoLarge"><?php 
